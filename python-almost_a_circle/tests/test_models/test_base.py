...
class Test_Base(unittest.TestCase):
    ...
    def test_base_id_assignment(self):
        """Test ensures automatic id assignment in multiple instances"""
        b1 = Base()
        b2 = Base()
    ...
    def test_nb_objects_increment(self):
        """Test ensures __nb_objects increments operates as expected"""
        b1 = Base()
        b2 = Base()
        self.assertEqual(Base._Base__nb_objects, 2)

    def test_to_json_string_none(self):
        """Test ensures empty input to to_json_string returns empty list."""
